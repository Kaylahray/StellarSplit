            ...
            <div className="relative bg-white rounded-t-3xl md:rounded-2xl w-full max-w-sm p-6 shadow-xl animate-in slide-in-from-bottom md:slide-in-from-bottom-0 md:zoom-in-95 duration-300">
                ...
                <div className="bg-white rounded-2xl p-8 mb-6 flex items-center justify-center border-2 border-gray-100 shadow-sm">
                    <div className="text-center">
                        <div className="w-48 h-48 bg-gray-900 rounded-xl flex items-center justify-center mb-4 mx-auto text-white shadow-lg">
                ...
                <div className="flex gap-3">
                    <button className="flex-1 bg-gray-50 hover:bg-gray-100 active:bg-gray-200 text-gray-900 font-bold py-3.5 px-4 rounded-xl transition-colors flex items-center justify-center gap-2 border border-gray-100">
                        <Copy size={18} /> Copy Link
                    </button>
                    <button className="flex-1 bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-purple-200 transition-colors flex items-center justify-center gap-2">
